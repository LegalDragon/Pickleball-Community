...
import { SharedLogin, SiteLogoOverlay } from '../components/shared-auth'
...
const Login = () => {
  ...
  // Handle successful login from shared auth
  const handleLoginSuccess = async ({ token, user }) => {
    ...
    try {
      ...
      setSyncError('Login succeeded but failed to sync user data. Please try again.')
    }
  }
