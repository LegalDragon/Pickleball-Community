...
-- =====================================================
-- Step 1: Remove unnecessary columns from EventFeeTypes
-- (DefaultAmount, AvailableFrom, AvailableUntil)
-- These belong on the fee itself (DivisionFees), not the type template
-- =====================================================
...
-- Drop the old FK constraint on DivisionId (will be re-added differently)
...
-- =====================================================
-- Step 3: Create fee types for orphaned fees (fees without FeeTypeId)
...
-- =====================================================
-- Step 4: Convert NULL DivisionId to 0 for event-level fees
-- =====================================================
...
-- =====================================================
-- Step 5: Make DivisionId NOT NULL with default 0
-- =====================================================
...
-- =====================================================
-- Step 6: Make EventId NOT NULL (was nullable)
-- =====================================================
...
-- =====================================================
-- Step 7: Add new check constraint
-- DivisionId = 0 for event-level, > 0 for division-level
-- =====================================================
...
-- =====================================================
-- Step 8: Create composite index for efficient lookups
-- =====================================================
